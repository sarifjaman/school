            ...
            <div class="container-fluid">
                <div class="row clearfix">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <a href="<?php echo ROOT; ?>/schools">
                            <div class="widget">
                                <div class="widget-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="state">
                                            <h6 class="head-col">Schools</h6>
                                            <h4 class="head4">1,410</h4>
                                        </div>
                                        <div class="icon">
                                            <i class="fa fa-graduation-cap iconic"></i>
                                        </div>
                                    </div>
                                    <small class="text-small mt-0 d-block">6% higher than last month</small>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <a href="<?php echo ROOT; ?>/users">
                            <div class="widget">
                                <div class="widget-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="state">
                                            <h6 class="head-col">Staff</h6>
                                            <h4 class="head4">1,410</h4>
                                        </div>
                                        <div class="icon">
                                            <i class="fa fa-chalkboard-teacher iconic"></i>
                                        </div>
                                    </div>
                                    <small class="text-small mt-0 d-block">61% higher than last month</small>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <a href="<?php echo ROOT; ?>/students">
                            <div class="widget">
                                <div class="widget-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="state">
                                            <h6 class="head-col">Students</h6>
                                            <h4 class="head4">410</h4>
                                        </div>
                                        <div class="icon">
                                            <i class="fa fa-user-graduate iconic"></i>
                                        </div>
                                    </div>
                                    <small class="text-small mt-0 d-block">Total Events</small>

                                    <hr>

                                    <div class="cfoot">
                                        View all students in the schools
                                    </div>
                                </div>
                                <div class="progress progress-sm">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <a href="<?php echo ROOT; ?>/classes">
                            <div class="widget">
                                <div class="widget-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="state">
                                            <h6 class="head-col">Classes</h6>
                                            <h4 class="head4">41,410</h4>
                                        </div>
                                        <div class="icon">
                                            <i class="fa fa-university iconic"></i>
                                        </div>
                                    </div>
                                    <small class="text-small mt-0 d-block">Total Comments</small>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <a href="<?php echo ROOT; ?>/tests">
                            <div class="widget">
                                <div class="widget-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="state">
                                            <h6 class="head-col">Tests</h6>
                                            <h4 class="head4">41,410</h4>
                                        </div>
                                        <div class="icon">
                                            <i class="fa fa-file-signature iconic"></i>
                                        </div>
                                    </div>
                                    <small class="text-small mt-0 d-block">Total Comments</small>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <a href="<?php echo ROOT; ?>/statistics">
                            <div class="widget">
                                <div class="widget-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="state">
                                            <h6 class="head-col">Statistics</h6>
                                            <h4 class="head4">41,410</h4>
                                        </div>
                                        <div class="icon">
                                            <i class="fa fa-chart-pie iconic"></i>
                                        </div>
                                    </div>
                                    <small class="text-small mt-0 d-block">Total Comments</small>
                        ...
                        <a href="<?php echo ROOT; ?>/settings">
                            <div class="widget">
                                <div class="widget-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="state">
                                            <h6 class="head-col">Settings</h6>
                                            <h4 class="head4">41,410</h4>
                                        </div>
                                        <div class="icon">
                                            <i class="fa fa-cogs iconic"></i>
                                        </div>
                                    </div>
                                    <small class="text-small mt-0 d-block">Total Comments</small>
                        ...
                        <a href="<?php echo ROOT; ?>/profile">
                            <div class="widget">
                                <div class="widget-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="state">
                                            <h6 class="head-col">Profile</h6>
                                            <h4 class="head4">41,410</h4>
                                        </div>
                                        <div class="icon">
                                            <i class="fa fa-id-card iconic"></i>
                                        </div>
                                    </div>
                                    <small class="text-small mt-0 d-block">Total Comments</small>
                        ...
                        <a href="<?php echo ROOT; ?>/logout">
                            <div class="widget">
                                <div class="widget-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="state">
                                            <h6 class="head-col">Logout</h6>
                                            <h4 class="head4">41,410</h4>
                                        </div>
                                        <div class="icon">
                                            <i class="fa fa-sign-out-alt iconic"></i>
                                        </div>
                                    </div>
                                    <small class="text-small mt-0 d-block">Total Comments</small>
