...
<div class="app-sidebar colored">
    <div class="sidebar-header">
        <a class="header-brand" href="<?php echo ROOT; ?>">
            <div class="logo-img">
                <img src="<?php echo ROOT; ?>/assets/img/logo/downloads.png" class="header-brand-img" alt="lavalite">
            </div>
            <span class="text"><?php echo Auth::getSchool_name(); ?></span>
        </a>
        ...
        <div class="nav-container">
            <nav id="main-menu-navigation" class="navigation-main">
                ...
                <div class="nav-item active">
                    <a href="<?php echo ROOT; ?>"><i class="ik ik-bar-chart-2"></i><span>Dashboard</span></a>
                </div>

                <div class="nav-item">
                    <a href="<?php echo ROOT; ?>/schools"><i class="fa fa-graduation-cap"></i><span>Schools</span> <span class="badge badge-success">New</span></a>
                </div>

                <div class="nav-item">
                    <a href="<?php echo ROOT; ?>/users"><i class="fa fa-chalkboard-teacher"></i><span>Staff</span> <span class="badge badge-success">New</span></a>
                </div>

                <div class="nav-item">
                    <a href="<?php echo ROOT; ?>/students"><i class="fa fa-user-graduate"></i><span>Students</span> <span class="badge badge-success">New</span></a>
                </div>

                <div class="nav-item">
                    <a href="<?php echo ROOT; ?>/classes"><i class="fa fa-university"></i><span>Classes</span> <span class="badge badge-success">New</span></a>
                </div>

                <div class="nav-item">
                    <a href="<?php echo ROOT; ?>/tests"><i class="fa fa-file-signature"></i><span>Tests</span> <span class="badge badge-success">New</span></a>
                </div>

                <div class="nav-item">
                    <a href="<?php echo ROOT; ?>/users"><i class="ik ik-users"></i><span>Users</span> <span class="badge badge-success">New</span></a>
                </div>

                <div class="nav-item has-sub">
                    <a href="javascript:void(0)"><i class="ik ik-user"></i><span>USER</span> <span class="badge badge-danger">150+</span></a>
                    <div class="submenu-content">
                        <a href="<?php echo ROOT; ?>/profile" class="menu-item">Profile</a>
                        <a href="<?php echo ROOT; ?>" class="menu-item">Dashboard</a>
                        <a href="<?php echo ROOT; ?>/logout" class="menu-item">Logout</a>
