                        ...
                        <div class="col-lg-4 col-md-5">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php
                                    $image =  get_image($data->image, $data->gender);
                                    ?>

                                    <div class="text-center">
                                        <img src="<?php echo $image; ?>" class="rounded-circle" width="150" />
                                        <h4 class="card-title mt-10"><?php echo esc($data->firstname); ?> <?php echo esc($data->lastname); ?></h4>
                                        <p class="card-subtitle"><?php echo esc(str_replace('_', ' ', ucwords($data->rank))); ?></p>
                            ...
                            <div class="card">
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="current-month" role="tabpanel" aria-labelledby="pills-timeline-tab">
                                        <div class="card-body">
                                            <?php $this->view("profilepill/profiletimeline", ['data' => $data]); ?>
                                        </div>
                                    </div>
